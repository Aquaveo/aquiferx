...
export default defineConfig(({ mode }) => {
    ...
    // Vercel preview deploys serve the app at the root of an
    // autogenerated subdomain (e.g. aquiferx-<hash>.vercel.app/), not at
    // the production subpath. Honoring VITE_BASE_PATH unconditionally
    // would emit asset URLs prefixed with /aquifer-analyst/ on a host
    // that serves them at /, producing 404s. Force base to / for any
    // non-production Vercel environment regardless of how the env vars
    // are configured.
